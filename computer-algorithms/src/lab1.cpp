...
// Умножение итеративное, функция запускается один раз и считает результат умножения, пока не дойдет конца массива
// Параметров нет.
int simple_multiple()
{
	int result;
...
int main()
{
	// Считаем и выводим результ. Умножение итерацией по массиву
